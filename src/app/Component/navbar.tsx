      ...
      <nav>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 font-inter2 font-bold">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-[] dark:hover:bg-[#80604f] dark:focus:ring-[#33261F]"
          ...
          <div className={`${isOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`} id="navbar-solid-bg" font-bold>
            <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-[#33261F] md:dark:bg-transparent dark:border-gray-700">
              <li>
                <a href="#introduction" className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#5a8c70] dark:text-white md:dark:hover:text-[#5a8c70] dark:hover:bg-[#80604f] dark:hover:text-white md:dark:hover:bg-transparent">About</a>
              </li>
              <li>
